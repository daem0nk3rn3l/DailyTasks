# Computer Information Output to HTML no headers
# Saved to present location 
# 3.13.26
#
#
...
$Report = ConvertTo-HTML -Body "$ComputerName $OSinfo $ProcessInfo $BiosInfo $DiscInfo" `
-Title "Computer Information" -Head $header -PostContent "<p>Creation Date: $(Get-Date)<p>"
#The command below will generate the report to an HTML file
$Report | Out-File .\Computer-Info.html
