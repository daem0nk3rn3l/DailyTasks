...
Function Ping-Host {
    ...
    #Find Maximum length of hostname to adjust column width accordingly
    ...
    while ($true) {
        ...
        $Hosts | %{
            ...
            if (Test-Connection $_ -Count 1 -Quiet -ErrorAction SilentlyContinue) {
                ...
                # format specifier/standard numeric formating : {0:N2} :  https://arcanecode.com/2021/07/19/fun-with-powershell-string-formatting/
